...
#
# Email Impacta: josue.silva@aluno.faculdadeimpacta.com.br
...
def eh_armstrong(n):
	...
	"""	
	nstring = str(n)
	n_digitos = len(nstring)
	return sum([ int(i) ** n_digitos for i in nstring]) == n
...
def eh_quase_armstrong(n):
	...
	nstring = str(n)
	n_digitos = len(nstring)
	soma = sum([ int(i) ** n_digitos for i in nstring])
	return soma + 1 == n or soma - 1 == n
